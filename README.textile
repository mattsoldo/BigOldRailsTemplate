...
# @rails NewProjectName -m /rails/BigOldRailsTemplate/lark_template.rb@ will then use your installed copy of Rails to create NewProjectName based on the template.
